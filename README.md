...
Copilot 3DMazeは、Pyxelを使用して作成されたシンプルな3D迷路脱出ゲームです。モンスター(赤)やトラップ(黄)を避けながら、鍵(ピンク)をとって赤い塔から脱出してください。このプロジェクトはGitHub Copilotを活用して開発されました。
...
[https://yamagame.github.io/copilot-3dmaze/](https://yamagame.github.io/copilot-3dmaze/)
